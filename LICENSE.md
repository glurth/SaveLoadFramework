# EyE Dual-License Agreement for SaveLoadFramework
Copyright (c) 2025 Glurth. All rights reserved.

This copyright applies to the **SaveLoadFramework** software package (the "Software"), including all source code, assets, and documentation.  
